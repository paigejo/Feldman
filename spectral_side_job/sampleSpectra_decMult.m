...
function [RMSE, maxPctDiff, maxError, RMSEsamples, trueMean, sampleMeans, waveNum] = sampleSpectra_decMult(swSearchStr, lwSearchStr, nSamples, nSimulations, useSW, useLW, lwHiRes, allSky, latRange, lonRange)
...
for sim = 1:nSimulations
    ...
    if sim == 1
        ...
        [RMSE_tmp, maxPctDiff_tmp, maxError_tmp, RMSEsamples, trueMean, sampleMeans_tmp, waveNum] = sampleSpectra_decadal(swSearchStr, lwSearchStr, nSamples, useSW, useLW, lwHiRes, allSky, latRange, lonRange);
        ...
        [RMSE_tmp, maxPctDiff_tmp, maxError_tmp, ~, ~, sampleMeans_tmp, ~] = sampleSpectra_decadal(swSearchStr, lwSearchStr, nSamples, useSW, useLW, lwHiRes, allSky, latRange, lonRange);
