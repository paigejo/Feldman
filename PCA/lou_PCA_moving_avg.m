...
%componentNumber]. Also, this 4-dimensional matrix may contain NaNs.  The
%searchStr input is the search string going into the ls system function,
%and is used to determine which data files should be used in the analysis.
...
function lou_PCA_moving_avg(useSW, useLW, saveName, savePath, swPath, lwPath, searchStr)
useSW = logical(useSW);
useLW = logical(useLW);
